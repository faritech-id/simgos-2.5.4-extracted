...
class MappingGroupPemeriksaanResource extends Resource
{
    protected $title = "Mapping Group Pemeriksaan";

	public function __construct() {
		parent::__construct();
		$this->service = new MappingGroupPemeriksaanService();
	}
    ...
    public function create($data)
    {
        $founds = $this->service->load([
            'GROUP_PEMERIKSAAN_ID' => $data->GROUP_PEMERIKSAAN_ID, 
    ...
    public function fetchAll($params = [])
    {
        ...
        $order = ["GROUP_PEMERIKSAAN_ID", "PEMERIKSAAN"];
        $data = null;        
