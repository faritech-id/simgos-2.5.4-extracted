...
class PermintaanDarahDetailResource extends Resource
{
    protected $title = "PermintaanDarah Detail";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT permintaan_darah_detail.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
