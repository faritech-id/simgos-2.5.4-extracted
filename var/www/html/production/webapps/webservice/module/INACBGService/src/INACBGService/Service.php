...
class Service {
	...
	public function validasiNomorRegisterSITB(array $data = null) {
		if($this->createService($data)) {			
			return $this->service->validasiNomorRegisterSITB($data);
		}
		return null;
	}

	public function batalValidasiNomorRegisterSITB(array $data = null) {
		if($this->createService($data)) {			
			return $this->service->batalValidasiNomorRegisterSITB($data);
		}
		return null;
	}
