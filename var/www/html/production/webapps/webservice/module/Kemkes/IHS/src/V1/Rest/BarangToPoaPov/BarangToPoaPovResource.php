...
class BarangToPoaPovResource extends Resource
{
    protected $title = "Barang To Poa Pov";
    ...
    public function update($id, $data)
    {
        ...
        $cek = $this->service->load(["BARANG" => $id]);
        $success = $this->service->simpanData($data, count($cek) == 0);
        if($success) {
            $result["status"] = 200;
            $result["success"] = true;
