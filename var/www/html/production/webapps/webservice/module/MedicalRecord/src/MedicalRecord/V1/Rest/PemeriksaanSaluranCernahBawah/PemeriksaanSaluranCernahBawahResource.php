...
class PemeriksaanSaluranCernahBawahResource extends Resource
{ 
    protected $title = "Pemeriksaan Saluran Cernah Bawah";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_saluran_cernah_bawah.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
