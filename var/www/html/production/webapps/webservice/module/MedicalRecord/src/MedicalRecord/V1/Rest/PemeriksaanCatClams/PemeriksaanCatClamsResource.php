...
class PemeriksaanCatClamsResource extends Resource
{
    protected $title = "Pemeriksaan Cat Clams";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_cat_clams.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
