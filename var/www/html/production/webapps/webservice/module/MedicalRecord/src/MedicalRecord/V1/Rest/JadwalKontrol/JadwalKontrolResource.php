...
class JadwalKontrolResource extends Resource
{
    ...
    public function create($data)
    {
        ...
        // $sysdate = System::getSysDate($adapter, false, true);
        // if(isset($data->TANGGAL)) {
        //     if($data->TANGGAL <= $sysdate) return new ApiProblem(412, 'Tanggal kontrol harus diatas dari tanggal hari ini');
        // }
