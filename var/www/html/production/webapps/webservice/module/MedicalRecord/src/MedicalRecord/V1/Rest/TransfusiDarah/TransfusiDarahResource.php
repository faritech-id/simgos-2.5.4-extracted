...
class TransfusiDarahResource extends Resource
{
    protected $title = "Transfusi Darah";
    ...
    public function fetchAll($params = [])
    {
            ...
            if(isset($params["NOPEN"])){
                $data = $this->service->execute([$params["NOPEN"]]);
                $total = count($data);
            } else{  
            ...
            if (isset($params["NOT"])) {
                ...
                foreach($nots as $key => $val) {                
                    $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_transfusi_darah.".$key." = ".$val.")");                
                }
                unset($params["NOT"]);
            }
