...
class PemeriksaanEkgResource extends Resource
{
    protected $title = "Pemeriksaan Ekg";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_ekg.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
