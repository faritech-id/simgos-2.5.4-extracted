...
class PenilaianBarthelIndexModifikasiResource extends Resource
{
    protected $title = "Penilaian Barthel Index Modifikasi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_barthel_index_modifikasi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
