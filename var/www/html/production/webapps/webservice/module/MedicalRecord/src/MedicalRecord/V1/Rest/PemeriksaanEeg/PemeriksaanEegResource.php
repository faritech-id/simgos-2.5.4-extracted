...
class PemeriksaanEegResource extends Resource
{
    protected $title = "Pemeriksaan Eeg";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_eeg.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
