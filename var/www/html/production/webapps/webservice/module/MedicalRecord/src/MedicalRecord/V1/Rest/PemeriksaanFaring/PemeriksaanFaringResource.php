...
class PemeriksaanFaringResource extends Resource
{
	protected $title = "Pemeriksaan Faring";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_faring.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
