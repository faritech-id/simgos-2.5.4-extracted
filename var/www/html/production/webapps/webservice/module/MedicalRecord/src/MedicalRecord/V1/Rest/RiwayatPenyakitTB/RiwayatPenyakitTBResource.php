...
class RiwayatPenyakitTBResource extends Resource
{
    protected $title = "Riwayat Penyakit Penyakit TB";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT riwayat_penyakit_tb .".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
