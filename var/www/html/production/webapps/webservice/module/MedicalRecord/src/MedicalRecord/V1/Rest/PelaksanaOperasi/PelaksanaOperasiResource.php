...
class PelaksanaOperasiResource extends Resource
{
    protected $title = "Pelaksana Operasi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pelaksana_operasi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
