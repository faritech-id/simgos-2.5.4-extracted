...
class DischargePlanningFaktorRisikoResource extends Resource
{
	protected $title = "Discharge Planning Faktor Risiko";
    ...
    {
        if(is_null($data->TANGGAL_REASSESSMENT)) unset($data->TANGGAL_REASSESSMENT);
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT discharge_planning_faktor_risiko.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
