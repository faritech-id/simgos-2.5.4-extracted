...
class PemeriksaanAsessmentMchatResource extends Resource
{
    protected $title = "Pemeriksaan Asessment M Chat";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_assesment_m_chat.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
