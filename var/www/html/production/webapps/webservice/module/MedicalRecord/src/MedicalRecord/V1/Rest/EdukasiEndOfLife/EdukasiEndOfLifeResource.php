...
class EdukasiEndOfLifeResource extends Resource
{
    protected $title = "Edukasi EndOfLife";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT edukasi_end_of_life.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
