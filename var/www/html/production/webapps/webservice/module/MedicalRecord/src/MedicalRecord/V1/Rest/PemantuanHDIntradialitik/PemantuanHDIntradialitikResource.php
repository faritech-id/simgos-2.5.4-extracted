...
class PemantuanHDIntradialitikResource extends Resource
{
    protected $title = "Pemantuan HD Intradialitik";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
            ...
            foreach($nots as $key => $val) {
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemantuan_hd_intradialitik.".$key." = ".$val.")");
            }
            unset($params["NOT"]);
        }
