...
class PenilaianBarthelIndexResource extends Resource
{
    protected $title = "Penilaian Barthel Index";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_barthel_index.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
