...
class PemeriksaanObservasiTransfusiDarahResource extends Resource
{
    protected $title = " Observasi Transfusi Darah";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
            ...
            foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_observasi_transfusi_darah.".$key." = ".$val.")");                
            }
            unset($params["NOT"]);
        }
