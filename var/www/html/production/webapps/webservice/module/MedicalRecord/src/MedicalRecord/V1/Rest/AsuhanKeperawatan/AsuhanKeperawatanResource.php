...
class AsuhanKeperawatanResource extends Resource
{
    protected $title = "Asuhan Keperawatan";
    ...
    public function fetchAll($params = [])
    {
        ...
        $order = ["asuhan_keperawatan.TANGGAL DESC"];
        $data = null;        
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT asuhan_keperawatan.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
