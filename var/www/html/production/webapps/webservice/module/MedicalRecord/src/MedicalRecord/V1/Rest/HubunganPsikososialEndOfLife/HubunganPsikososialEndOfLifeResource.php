...
class HubunganPsikososialEndOfLifeResource extends Resource
{
    protected $title = "Hubungan Psikososial End Of Life";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT hubungan_psikososial_end_of_life.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
