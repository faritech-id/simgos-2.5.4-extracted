...
class RiwayatGynekologiResource extends Resource
{
    protected $title = "Riwayat Gynekologi";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT riwayat_gynekologi.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
