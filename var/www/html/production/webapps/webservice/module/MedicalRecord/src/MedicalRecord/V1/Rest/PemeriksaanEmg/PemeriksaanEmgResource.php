...
class PemeriksaanEmgResource extends Resource
{
    protected $title = "Pemeriksaan Emg";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT pemeriksaan_emg.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
