...
class Service extends DBService {
	...
	public function __construct($includeReferences = true /* $references = array() */) {
		$this->config["entityName"] = "MedicalRecord\\V1\\Rest\\ResumeHasilLab\\ResumeHasilLabEntity";
		$this->table = DatabaseService::get("SIMpel")->get(new TableIdentifier("listHasilLab", "medicalrecord"));
		$this->entity = new ResumeHasilLabEntity();
	...
	public function ListHasilLab($nopen) {
		$adapter = DatabaseService::get('SIMpel')->getAdapter(); 
		$stmt = $adapter->query('CALL medicalrecord.listHasilLab(?)');
