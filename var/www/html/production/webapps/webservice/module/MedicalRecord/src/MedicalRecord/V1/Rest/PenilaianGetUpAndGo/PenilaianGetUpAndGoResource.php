...
class PenilaianGetUpAndGoResource extends Resource
{
	protected $title = "Penilaian Get Up and Go";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT penilaian_getup_and_go.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
