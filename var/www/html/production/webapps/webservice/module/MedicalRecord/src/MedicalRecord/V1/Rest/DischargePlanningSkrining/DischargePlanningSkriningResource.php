...
class DischargePlanningSkriningResource extends Resource
{
	protected $title = "Discharge Planning Skrining";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT discharge_planning_skrining.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
