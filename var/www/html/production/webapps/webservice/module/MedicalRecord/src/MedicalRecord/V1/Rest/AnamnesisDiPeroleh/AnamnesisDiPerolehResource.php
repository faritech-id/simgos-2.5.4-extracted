...
class AnamnesisDiPerolehResource extends Resource
{
	protected $title = "Anamnesis Diperoleh";
    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT anamnesis_diperoleh.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}
