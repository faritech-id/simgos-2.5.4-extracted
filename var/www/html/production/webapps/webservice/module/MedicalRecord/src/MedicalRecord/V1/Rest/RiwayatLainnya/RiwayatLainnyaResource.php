...
class RiwayatLainnyaResource extends Resource
{
    protected $title = "Riwayat Lainnya";
    ...
    public function fetchAll($params = [])
    {
      ...
      if (isset($params["NOT"])) {
        ...
        foreach($nots as $key => $val) {                
          $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT riwayat_lainnya.".$key." = ".$val.")");                
        }
        unset($params["NOT"]);
      }
