    ...
    public function fetchAll($params = [])
    {
        ...
        if (isset($params["NOT"])) {
			...
			foreach($nots as $key => $val) {                
                $params[] = new \Laminas\Db\Sql\Predicate\Expression("(NOT str_sip.".$key." = ".$val.")");                
			}
			unset($params["NOT"]);
		}

        $isShowFile = ($params["SHOW_FILE"]==0)? false : true;
		unset($params["SHOW_FILE"]);
        $total = $this->service->getRowCount($params);
        $params["SHOW_FILE"] = $isShowFile;
