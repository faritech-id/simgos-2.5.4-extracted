...
{
    protected $title = "Pembatalan Final Tagihan";
    ...
    public function create($data)
    {
        ...
        if($this->service->sudahKlaim($data["TAGIHAN"])) return new ApiProblem(428, '<b>Tagihan: '.$data["TAGIHAN"].'</b><br/>Tidak dapat dibatalkan karena sudah di klaim');
