				...
				BEGIN
			   	...
			   	IF VSELISIH > 0 THEN
			   		...
			   		IF VSELISIH <= VSELMAX THEN
					   	SET VSELISIH_MINIMAL = IF(VGUNAKANPERSENTASE = 1, VSELMIN, VSELISIH - VSELKELAS1KURANGHAKKELAS);
					   ELSE
					   	SET VSELISIH_MINIMAL = IF(VGUNAKANPERSENTASE = 1, VSELMIN, VSELMAX - VSELKELAS1KURANGHAKKELAS);
					   END IF;
				   ELSE
