...
-- Dumping structure for trigger kemkes-ihs.allergy_intolerance_before_insert
DROP TRIGGER IF EXISTS `allergy_intolerance_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `allergy_intolerance_before_insert` BEFORE INSERT ON `allergy_intolerance` FOR EACH ROW BEGIN
