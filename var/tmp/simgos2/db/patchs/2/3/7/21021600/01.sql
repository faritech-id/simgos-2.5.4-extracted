...
DELIMITER //
CREATE EVENT `onAutoForSecond` ON SCHEDULE EVERY 1 SECOND STARTS '2013-09-10 15:22:25' ON COMPLETION PRESERVE ENABLE DO BEGIN
	DECLARE vtanggal DATE;
	DECLARE vfound TINYINT DEFAULT 0;
	
	SELECT COUNT(*), TANGGAL INTO vfound, vtanggal
	  FROM master.tanggal
