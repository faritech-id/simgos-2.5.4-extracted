...
-- Dumping structure for trigger kemkes-ihs.composition_before_update
DROP TRIGGER IF EXISTS `composition_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `composition_before_update` BEFORE UPDATE ON `composition` FOR EACH ROW BEGIN
