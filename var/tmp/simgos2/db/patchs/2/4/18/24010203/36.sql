...
BEGIN
	...
	DECLARE CR_TANDAVITAL CURSOR FOR
		SELECT DISTINCT tv.ID, tv.SISTOLIK, tv.DISTOLIK, tv.FREKUENSI_NADI, tv.FREKUENSI_NAFAS, tv.SUHU, pn.NOMOR NOPEN, tv.TANGGAL TANGGAL, `dateFormatUTC`(tv.WAKTU_PEMERIKSAAN, 1), pn.NORM
