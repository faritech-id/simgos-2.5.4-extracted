...
BEGIN
	...
	IF FOUND_ROWS() > 0 THEN
		...
		BEGIN
			...
			SELECT pt.TOTAL, pt.TOTAL_NAIK_KELAS, pt.NAIK_KELAS, pt.NAIK_KELAS_VIP, pt.NAIK_DIATAS_VIP, pt.TOTAL_TAGIHAN_HAK, pt.SUBSIDI_TAGIHAN, pt.SELISIH_MINIMAL, pt.TOTAL_TAGIHAN_VIP, pt.KELAS_KLAIM
			  INTO VTOTAL_JAMINAN, VTARIF_NAIK_KELAS, VNAIK_KELAS, VNAIK_KELAS_VIP, VNAIK_DIATAS_VIP, VTOTAL_TAGIHAN_HAK, VSUBSIDI_TAGIHAN, VSELISIH_MINIMAL, VTOTAL_TAGIHAN_VIP, VKELAS_KLAIM
			  FROM pembayaran.penjamin_tagihan pt
			 WHERE pt.TAGIHAN = PTAGIHAN
			   AND pt.PENJAMIN = 2;
			...
			BEGIN					
				...
				BEGIN
					...
					SET VSELTGHN = VTOTAL_TAGIHAN_VIP - VTARIF_NAIK_KELAS;
				   ...
				   UPDATE pembayaran.penjamin_tagihan pt
					   SET pt.TOTAL_NAIK_KELAS = IF(VSELISIH > 0, pt.TARIF_INACBG_KELAS1, VSEL),
