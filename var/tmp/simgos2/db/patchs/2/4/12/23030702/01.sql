						...
						IF OLD.ALASAN_TIDAK_TERLAYANI = "" OR OLD.ALASAN_TIDAK_TERLAYANI IS NULL THEN
							BEGIN
								...
								IF VSTATUS_VALIDASI_HARI > 0 THEN
									SET VHARI = IF(NEW.HARI > 0,1,NEW.HARI);
								ELSE
									SET VHARI = NEW.HARI;
								END IF;
								/* Script Batas Layanan Obat */
								...
								END IF;
								/* End Script Set Bon Sisa */
							END;
							
							IF NEW.TINDAKAN_PAKET = 0 THEN #ScriptLine Untuk Tindakan Paket Tidak Masuk Tagihan
