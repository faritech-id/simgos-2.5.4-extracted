		...
		IF VKELAS_RAWAT > 2 THEN
			...
			UPDATE pembayaran.penjamin_tagihan pt
			   SET pt.TOTAL_NAIK_KELAS = pt.TARIF_INACBG_KELAS1
			       , pt.NAIK_KELAS = IF(VKELAS_RAWAT > 2, 1, 0)
			   	 , pt.NAIK_KELAS_VIP = IF(VKELAS_RAWAT > 3, 1, 0)
					 , pt.NAIK_DIATAS_VIP = IF(VKELAS_RAWAT > 4, 1, 0)
		...
		BEGIN
			...
			BEGIN					
				...
				BEGIN
				   ...
				   UPDATE pembayaran.penjamin_tagihan pt
					   SET pt.TOTAL_NAIK_KELAS = IF(VSEL > 0, pt.TARIF_INACBG_KELAS1, VSEL),
