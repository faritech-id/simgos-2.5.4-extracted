...
-- membuang struktur untuk table kemkes-sirs.rl3-13
CREATE TABLE IF NOT EXISTS `rl3-13` (
  `object_id` int NOT NULL AUTO_INCREMENT,
  `id` int DEFAULT NULL COMMENT 'ID KEMKES',
  `tahun` year NOT NULL COMMENT '-',
  `no` tinyint NOT NULL COMMENT '-',
  `golongan_obat` varchar(200) NOT NULL COMMENT '-',
  `jumlah_item_obat` int NOT NULL DEFAULT '0' COMMENT '-',
  `jumlah_item_obat_yang_tersedia_di_rs` int NOT NULL DEFAULT '0' COMMENT '-',
  `jumlah_item_obat_formulatorium_yang_tersedia_di_rs` int NOT NULL DEFAULT '0' COMMENT '-',
