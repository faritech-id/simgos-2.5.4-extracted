...
-- membuang struktur untuk table kemkes-sirs.rl3-6
CREATE TABLE IF NOT EXISTS `rl3-6` (
  `object_id` int NOT NULL AUTO_INCREMENT,
  `id` int DEFAULT NULL COMMENT 'ID KEMKES',
  `tahun` year NOT NULL COMMENT '-',
  `no` smallint NOT NULL COMMENT '-',
  `spesialisasi` varchar(200) NOT NULL COMMENT '-',
  `total` smallint NOT NULL DEFAULT '0' COMMENT '-',
  `khusus` smallint NOT NULL DEFAULT '0' COMMENT '-',
  `besar` smallint NOT NULL DEFAULT '0' COMMENT '-',
  `sedang` smallint NOT NULL DEFAULT '0' COMMENT '-',
  `kecil` smallint NOT NULL DEFAULT '0' COMMENT '-',
