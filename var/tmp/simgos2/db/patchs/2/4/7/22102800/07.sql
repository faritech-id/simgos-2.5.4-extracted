...
-- membuang struktur untuk table kemkes-sirs.rl2
CREATE TABLE IF NOT EXISTS `rl2` (
  `object_id` int NOT NULL AUTO_INCREMENT,
  `id` int DEFAULT NULL COMMENT 'ID KEMKES',
  `tahun` year NOT NULL COMMENT '-',
  `no_kode` char(6) NOT NULL COMMENT '-',
  `kualifikasi_pendidikan` varchar(200) NOT NULL COMMENT '-',
  `keadaan_laki_laki` smallint NOT NULL COMMENT '-',
  `keadaan_perempuan` smallint NOT NULL COMMENT '-',
  `kebutuhan_laki_laki` smallint NOT NULL COMMENT '-',
  `kebutuhan_perempuan` smallint NOT NULL COMMENT '-',
  `kekurangan_laki_laki` smallint NOT NULL COMMENT '-',
  `kekurangan_perempuan` smallint NOT NULL COMMENT '-',
  ...
  UNIQUE KEY `tahun_no_kode` (`tahun`,`no_kode`),
