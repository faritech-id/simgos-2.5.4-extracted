...
-- membuang struktur untuk table kemkes-sirs.rl1-3
CREATE TABLE IF NOT EXISTS `rl1-3` (
  ...
  `jumlah_tt` smallint NOT NULL COMMENT '-',
  `vvip` smallint NOT NULL COMMENT '-',
  `vip` smallint NOT NULL COMMENT '-',
  `i` smallint NOT NULL COMMENT '-',
  `ii` smallint NOT NULL COMMENT '-',
  `iii` smallint NOT NULL COMMENT '-',
  `kelas_khusus` smallint NOT NULL COMMENT '-',
