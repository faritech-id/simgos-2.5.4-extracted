...
-- membuang struktur untuk table kemkes-sirs.rl3-13b
CREATE TABLE IF NOT EXISTS `rl3-13b` (
  ...
  `rawat_jalan` int NOT NULL DEFAULT '0' COMMENT '-',
  `igd` int NOT NULL DEFAULT '0' COMMENT '-',
  `rawat_inap` int NOT NULL DEFAULT '0' COMMENT '-',
