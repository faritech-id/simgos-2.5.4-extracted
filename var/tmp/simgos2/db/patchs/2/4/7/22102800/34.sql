...
-- membuang struktur untuk table kemkes-sirs.rl5-1
CREATE TABLE IF NOT EXISTS `rl5-1` (
  ...
  `jumlah` mediumint NOT NULL DEFAULT '0' COMMENT '-',
  ...
  UNIQUE KEY `tahun_bulan_no` (`tahun`,`bulan`,`no`) USING BTREE,
