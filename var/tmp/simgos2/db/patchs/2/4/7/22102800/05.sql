...
-- membuang struktur untuk trigger kemkes-sirs.rl1-3_before_update
DROP TRIGGER IF EXISTS `rl1-3_before_update`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `rl1-3_before_update` BEFORE UPDATE ON `rl1-3` FOR EACH ROW BEGIN
	IF NEW.jumlah_tt != OLD.jumlah_tt
