...
CREATE TRIGGER `onAfterUpdateKunjungan` AFTER UPDATE ON `kunjungan` FOR EACH ROW BEGIN
	...
	ELSE
		BEGIN
			...
			IF VJENIS_KUNJUNGAN IS NULL THEN
	...
	BEGIN		
		...
		SELECT dga.KODE, p.NORM 
		  INTO VDIAGNOSA, VNORM
