...
BEGIN 	
	...
	#	 , IF(rm.DESKRIPSI_HASIL_LAB='', medicalrecord.getHasilLaboratoriumResume(rm.NOPEN), rm.DESKRIPSI_HASIL_LAB) LAB
		 ...
		 #, IF(rm.DESKRIPSI_HASIL_RAD='', medicalrecord.getHasilRadiologiResume(rm.NOPEN), rm.DESKRIPSI_HASIL_RAD) RAD
