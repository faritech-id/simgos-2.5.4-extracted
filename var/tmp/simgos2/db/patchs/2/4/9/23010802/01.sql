...
BEGIN
	...
	DECLARE CRDATA CURSOR FOR
		SELECT c.NOMOR, b.FARMASI, b.JUMLAH, b.DOSIS, b.ATURAN_PAKAI, b.KETERANGAN
			, b.RACIKAN, b.GROUP_RACIKAN, b.PETUNJUK_RACIKAN, b.JUMLAH_RACIKAN, b.FREKUENSI, b.RUTE_PEMBERIAN
	...
	OPEN CRDATA;
		DATA_END: LOOP
			FETCH CRDATA INTO VKUNJUNGAN, VFARMASI, VJUMLAH, VDOSIS, VATURAN_PAKAI, VKETERANGAN
				, VRACIKAN, VGROUP_RACIKAN, VPETUNJUK_RACIKAN, VJUMLAH_RACIKAN, VFREKUENSI, VRUTE_PEMBERIAN;
			...
			BEGIN
				...
				INSERT INTO layanan.farmasi(ID, KUNJUNGAN, FARMASI, JUMLAH, ATURAN_PAKAI, KETERANGAN
					, RACIKAN, GROUP_RACIKAN, PETUNJUK_RACIKAN, JUMLAH_RACIKAN, DOSIS, FREKUENSI, RUTE_PEMBERIAN
					, TANGGAL, OLEH)
					VALUES(VIDFARMASI, VKUNJUNGAN, VFARMASI, VJUMLAH, VATURAN_PAKAI, VKETERANGAN
					, VRACIKAN, VGROUP_RACIKAN, VPETUNJUK_RACIKAN, VJUMLAH_RACIKAN, VDOSIS, VFREKUENSI, VRUTE_PEMBERIAN
					, NOW(), POLEH);
