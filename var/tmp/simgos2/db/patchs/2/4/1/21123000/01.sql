...
BEGIN
	...
	FROM bpjs.kunjungan k
		  ...
		  LEFT JOIN bpjs.referensi proc ON k.tujuanKunj=proc.kode AND proc.jenis_referensi_id=8
		  LEFT JOIN bpjs.referensi kdp ON k.tujuanKunj=kdp.kode AND kdp.jenis_referensi_id=9
		  LEFT JOIN bpjs.referensi assp ON k.tujuanKunj=assp.kode AND assp.jenis_referensi_id=10
		, (SELECT mp.NAMA 
