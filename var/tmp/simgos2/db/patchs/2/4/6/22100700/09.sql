...
USE `kemkes-ihs`;
-- Dumping structure for table kemkes-ihs.encounter
CREATE TABLE IF NOT EXISTS `encounter` (
  ...
  `serviceProvider` json DEFAULT NULL,
  `refId` char(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
