...
-- Dumping structure for table medicalrecord.rekonsiliasi_obat
CREATE TABLE IF NOT EXISTS `rekonsiliasi_obat` (
...
-- Dumping data for table medicalrecord.rekonsiliasi_obat: ~0 rows (approximately)
/*!40000 ALTER TABLE `rekonsiliasi_obat` DISABLE KEYS */;
/*!40000 ALTER TABLE `rekonsiliasi_obat` ENABLE KEYS */;
