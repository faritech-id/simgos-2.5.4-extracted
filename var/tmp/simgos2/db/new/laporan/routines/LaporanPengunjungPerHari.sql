...
-- membuang struktur untuk procedure laporan.LaporanPengunjungPerHari
DROP PROCEDURE IF EXISTS `LaporanPengunjungPerHari`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `LaporanPengunjungPerHari`(
	IN `TGLAWAL` DATETIME,
