...
-- membuang struktur untuk trigger inventory.barang_after_insert
DROP TRIGGER IF EXISTS `barang_after_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
CREATE TRIGGER `barang_after_insert` AFTER INSERT ON `barang` FOR EACH ROW BEGIN
