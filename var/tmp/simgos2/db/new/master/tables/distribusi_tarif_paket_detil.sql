...
-- membuang struktur untuk table master.distribusi_tarif_paket_detil
DROP TABLE IF EXISTS `distribusi_tarif_paket_detil`;
CREATE TABLE IF NOT EXISTS `distribusi_tarif_paket_detil` (
  `ID` int(10) NOT NULL AUTO_INCREMENT,
  `PAKET_DETIL` smallint(11) NOT NULL,
