...
BEGIN
	...
	SET @sqlText = CONCAT('
		SELECT rkt.ID, rgn.ID RUANGAN_ID, rgn.DESKRIPSI RUANGAN, rk.ID KAMAR_ID, rk.KAMAR DESK_KAMAR, rkls.DESKRIPSI KAMAR, rkt.TEMPAT_TIDUR, rkt.NORM, rkt.NAMA, rkt.NOPEN
