...
-- membuang struktur untuk procedure informasi.list10DiagnosaRDKemkes
DROP PROCEDURE IF EXISTS `list10DiagnosaRDKemkes`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `list10DiagnosaRDKemkes`(
	IN `PTGL_AWAL` DATE,
	IN `PTGL_AKHIR` DATE
