...
-- membuang struktur untuk procedure informasi.list10DiagnosaRIKemkes
DROP PROCEDURE IF EXISTS `list10DiagnosaRIKemkes`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `list10DiagnosaRIKemkes`(
	IN `PTGL_AWAL` DATE,
	IN `PTGL_AKHIR` DATE
)
BEGIN
