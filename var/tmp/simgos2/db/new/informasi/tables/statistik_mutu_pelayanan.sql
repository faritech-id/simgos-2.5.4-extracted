...
-- membuang struktur untuk table informasi.statistik_mutu_pelayanan
DROP TABLE IF EXISTS `statistik_mutu_pelayanan`;
CREATE TABLE IF NOT EXISTS `statistik_mutu_pelayanan` (
