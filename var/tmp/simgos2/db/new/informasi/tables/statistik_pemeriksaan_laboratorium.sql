...
-- membuang struktur untuk table informasi.statistik_pemeriksaan_laboratorium
DROP TABLE IF EXISTS `statistik_pemeriksaan_laboratorium`;
CREATE TABLE IF NOT EXISTS `statistik_pemeriksaan_laboratorium` (
  `TAHUN` smallint(6) NOT NULL,
  `BULAN` tinyint(4) NOT NULL,
  `KODE` tinyint(4) NOT NULL,
  `REF_ID_KEMKES` char(50) NOT NULL,
  `RATA_RATA` decimal(10,2) NOT NULL DEFAULT '0.00',
  `JUMLAH_PASIEN` smallint(6) NOT NULL DEFAULT '0',
