...
-- membuang struktur untuk table informasi.statistik_jumlah_kematian
DROP TABLE IF EXISTS `statistik_jumlah_kematian`;
CREATE TABLE IF NOT EXISTS `statistik_jumlah_kematian` (
