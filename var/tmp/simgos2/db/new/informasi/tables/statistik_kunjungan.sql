...
-- membuang struktur untuk table informasi.statistik_kunjungan
DROP TABLE IF EXISTS `statistik_kunjungan`;
CREATE TABLE IF NOT EXISTS `statistik_kunjungan` (
  `TANGGAL` date NOT NULL,
  `REF_ID_KEMKES` char(50) NOT NULL,
  `RJ` smallint(6) NOT NULL DEFAULT '0',
  `RD` smallint(6) NOT NULL DEFAULT '0',
  `RI` smallint(6) NOT NULL DEFAULT '0',
