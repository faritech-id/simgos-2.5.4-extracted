...
CREATE DATABASE IF NOT EXISTS `medicalrecord` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `medicalrecord`;

-- membuang struktur untuk table medicalrecord.penanda_gambar
CREATE TABLE IF NOT EXISTS `penanda_gambar` (
