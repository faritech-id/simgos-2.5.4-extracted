...
-- membuang struktur untuk table medicalrecord.jadwal_kontrol
DROP TABLE IF EXISTS `jadwal_kontrol`;
CREATE TABLE IF NOT EXISTS `jadwal_kontrol` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `KUNJUNGAN` char(19) NOT NULL,
  `NOMOR` CHAR(6) NOT NULL DEFAULT '' COMMENT 'Nomor Surat Kontrol',
